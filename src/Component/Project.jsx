  ...
  return (
    <>
      ...
      <div className="project">
        ...
        <img src="src/images/images.jpeg" className="profile-picture" alt="Profile Picture"/>
        <h2>Maniraj Rai</h2>
        <p>Front-Developer</p>
                ...
                <div className="modal-body">
                    <form>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="title" placeholder="Enter your title"></input>
                        </div>
                        <div className="mb-3">
                            <label for="facebook" className="form-label">Facebook</label>
                            <input type="text" className="form-control" id="facebook" placeholder="Enter your Facebook URL"></input>
                        </div>
                        <div className="mb-3">
                            <label for="twitter" className="form-label">Twitter</label>
                            <input type="text" className="form-control" id="twitter" placeholder="Enter your Twitter URL"></input>
                        </div>
                        <div className="mb-3">
                            <label for="linkedin" className="form-label">LinkedIn</label>
                            <input type="text" className="form-control" id="linkedin" placeholder="Enter your LinkedIn URL"></input>
                        </div>
                    </form>
                </div>
